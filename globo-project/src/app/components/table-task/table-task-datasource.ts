...
const EXAMPLE_DATA: TableTaskItem[] = [
 ...
 */
export class TableTaskDataSource extends DataSource<TableTaskItem> {
  data: TableTaskItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<TableTaskItem[]> {
   ...
   */
  private getPagedData(data: TableTaskItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TableTaskItem[]) {
